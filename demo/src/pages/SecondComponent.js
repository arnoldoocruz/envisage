        ...
        <div style = {{position:'relative', width:'100%', height:'100%'}}>
            <div className="component second-component">
              ...
              <div className="mobile-about-third">
                ...
                <p className="text-content-rt-1" style={{fontSize: '2.5vw', marginBottom: '4vw'}}>trained, shaped, basking (you name it!) in Graphic and Interior Design. At some point, I flitted towards the sun in California to open my own independent design studio, specialising in creating a visual voice for premium brands. In 2005, I packed my agency (plus a couple of awards and some clothes!) and moved to Tel Aviv.</p>
                <p className="text-content-rt-1" style={{fontSize: '2.5vw'}}>That slightly twisted result is what our company Envisage, seeks to reproduce for every, single client. For every bonkers brand, impossible idea. Sure, it sounds a little dramatic and far fetched - but don’t worry, behind every star we sculpt for you is a talented team.</p>
              </div>
              <div className="mobile-about-fourth">
                <h6>I am Ryan Lev-Ari</h6>
                <p className="text-content-rt-1" style={{fontSize: '2.5vw', marginBottom: '4vw'}}>Dreams and visions are, of course, completely different. It is much like what it means to think, but not to act- to be lost in the potential of an idea rather than to reap its fruits. However, If reality and imagination are combined– if dreamscapes are fused with the focus of vision, a star is born! (Albeit a little irregularly shaped!).</p>
              </div>
              <div className="mobile-about-fifth">
                <h6 className="text-title-pinc-rt">My approach</h6>
                <p className="text-content-rt-4" style={{fontSize: '2.5vw'}}>wherever I practice, has always been simple. I relish in contrasts! Chiaroscuro; natural and industrial; art and commerce. My vision has always been to develop a strand of art or a style of commerce that oozes an intimate and harmonious balance between the two.</p>
              </div>
            </div>
