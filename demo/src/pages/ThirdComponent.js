      ...
      <div className="component third-component">
        <div className="thrid-container-white">
          ...
          <div>
            ...
            <span className="third-text-content-black-rt"><a>conceptual branding</a><a>concept creation</a></span>
          </div>
        </div>
        <div className="thrid-container-black">
          ...
          <div className="third-second-first-rt">
            ...
            <span className="third-text-content-white-rt"><a>package design</a><a>furniture design</a><a>ideas creation and trends</a></span>
          </div>
          <div className="third-second-second-rt">
            <h5 className="third-text-header-yellow-rt">Our Process</h5>
            <span className="third-text-content-yellow-rt">is to nurture any nugget or seedling you may have</span>
          </div>
        </div>
        <div className="thrid-container-white">
          <div className="third-blank-33-rt"></div>
          <div className="third-blank-33-rt">
            ...
            <span className="third-text-content-black-rt-light"><a>restaurant</a><a>coffee shop</a><a>stores</a></span>
          </div>
          <div className="third-blank-33-rt third-third-content-rt">
            <span className="third-text-content-yellow-rt">and craft it into something whole. You could bring us: a simple a word, a sketch - (or just a feeling!) and we will bring your brand to life.</span>
          </div>
        </div>
        <div className="thrid-container-black">
          ...
          <div>
            ...
            <div style={{textAlign: 'left'}}>
              <span className="third-text-content-white-rt"><a>apps</a><a>websites</a></span>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="mobile-special-first">
              <div className="mobile-special-white">
                ...
                <div className="mobile-special-content">
                  <div className="mobile-special-padding">
                  </div>
                  <div>
                    <h5 className="mobile-special-title-black">Branding |</h5>
                    <span className="mobile-special-content-black"><a>conceptual branding</a><a>concept creation</a></span>
                  </div>
              ...
              <div className="mobile-special-black">
                ...
                <div className="mobile-special-content">
                  ...
                  <div>
                    ...
                    <span className="mobile-special-content-white"><a>apps</a><a>websites</a></span>
                  </div>
            ...
            <div className="mobile-special-first">
              <div className="mobile-special-black">
                ...
                <div className="mobile-special-content">
                  ...
                  <div>
                    <h5 className="mobile-special-title-white">Product Design |</h5>
                    <span className="mobile-special-content-white"><a>package design</a><a>furniture design</a><a>ideas creation and trends</a></span>
                  </div>
                  <img src='public/img/mobile/special/circle-white.png' />
                </div>
              </div>
              <div className="mobile-special-white">
                ...
                <div className="mobile-special-content">
                  ...
                  <div>
                    <h5 className="mobile-special-title-black">Interior Design |</h5>
                    <span className="mobile-special-content-black"><a>restaurant</a><a>coffee shop</a><a>stores</a></span>
                  </div>
                  <img src='public/img/mobile/special/circle-black.png' />
                </div>
              </div>
