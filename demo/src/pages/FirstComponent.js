    ...
    return (
      <div className="component first-component" id='id-home-back'>
        <div className="main-content-rt">
          <div className="first-blank-33-rt">
          </div>
  
          <div className="content-middle-rt">
            <div className="first-column-26-rt">
            </div>
            <div className="first-column-74-rt">
              <div className="first-row-31">
              </div>
            ...
            <div className="first-main-description-area-rt">
              ...
              <div className="flex-w-60">
                <div className="first-description-title-rt">
                  <p>with a holistic approach, specialising in creating a visual voice for premium brands.</p>
                </div>
                <div className="first-description-content-rt">
                  <p>Envisage is for those that want conceptual branding, interior design product design and ideas creation.</p>
                </div>
                <div className="first-description-content-rt">
                  <p>It is imperative for my team and I, that we ensure the very root of your brand is felt by each consumer. That your story may be told, that your personality may be understood - and most importantly- that in the end you see what you had Envisaged.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="first-left-arrow-rt">
          <img src="public/img/homepage/left-arrow.png" onClick={handleClickPrev} />
        </div>
        <div className="first-right-arrow-rt">
          <img src="public/img/homepage/right-arrow.png" onClick={handleClickNext} />
        </div>
      </div>
    );
  } else {
      ...
      <div style={{position: 'relative', width: '100%', height: '100%'}}>
        <div className="component first-component">
          ...
          <div className="mobile-home-content">
            <p>Envisage is for those that want conceptual branding, interior design product design and ideas creation.
            It is imperative for my team and I, that we ensure the very root of your brand is felt by each consumer. That your story may be told, that your personality may be understood - and most importantly- that in the end you see what you had Envisaged.</p>
          </div>
        </div>
