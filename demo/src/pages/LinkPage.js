      ...
      <div className="menuPage" id="id-mobile-link-page">
        <div className="mobile-menu-first">
          ...
          <ul className="menu-page-list">
            <li num={0} onClick={handleLink}>
              First project
            </li>
            <li num={1} onClick={handleLink}>
              Second project
            </li>
            <li num={2} onClick={handleLink}>
              Third project
            </li>
            <li num={3} onClick={handleLink}>
              Fourth project
            </li>
            <li num={4} onClick={handleLink}>
              Fifth project
            </li>
          </ul>
        </div>
        <div className="mobile-menu-project-second">
          ...
          <br></br>
          <span>
            You can see detailed description of the project select anyone you
            want
          </span>
        </div>
