    ...
    if(!showDetail) {
      return (
        <div className="component fifth-component">
          <div className="fifth-img-back-rt">
          </div>
          <div className="fifth-content" id="id-journal-summary">
            ...
            <div className="fifth-journal-summary-content-rt">
              <div className="fifth-content-element">
                <img src="public/img/journal/journal2.png" onClick={handleDetailClick} />
                <h5>Mizzi Studio</h5>
                <h6>Jonathan Mizzi</h6>
                <p>This is content.<br/>This is description.<br/>This is detailed description.</p>
              </div>
              <div className="fifth-content-element">
                <img src="public/img/journal/journal1.png" onClick={handleDetailClick} />
                <h5>India Mahdavi</h5>
