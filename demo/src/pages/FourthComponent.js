...
import {
  setShowDetail,
  setNavbarNum,
  setProjectDetailImageNum,
  setProjectSummaryImageNum,
  setShowLink,
} from "../actions";
...
export default props => {
  ...
  const displayProjectPanel = useSelector(
    state => state.main.displayProjectPanel,
  );
  ...
  const projectDetailImageNum = useSelector(
    state => state.main.projectDetailImageNum,
  );
        ...
        <div className="fourth-content-rt">
          ...
          {!showDetail ? (
              ...
              <div className="fourth-project-summary-photo-rt">
                <Carousel id="id-main-projects" ref={summaryCarouselRef}>
                  <div className="fourth-summary-inner-div">
                    <img
                      src="public/img/projects/project1.png"
                  ...
                  <div className="fourth-carousel-2-elements-rt fourth-summary-inner-div">
                    <div style={{ position: "relative" }}>
                      <img
                        src="public/img/projects/project2.png"
                        onClick={handleDisplayDetail}
                    ...
                    <div style={{ position: "relative" }}>
                      <img
                        src="public/img/projects/project3.png"
                        onClick={handleDisplayDetail}
                        style={{ width: "28.7vw", maxHeight: "38vh" }}
                      />
                      <div className="fourth-project-description-on-image-rt">
                  ...
                  <div className="fourth-summary-inner-div">
                    <img
                      src="public/img/projects/project4.png"
                      onClick={handleDisplayDetail}
                  ...
                  <div className="fourth-summary-inner-div">
                    <img
                      src="public/img/projects/project5.png"
                      onClick={handleDisplayDetail}
                      style={{ width: "17.3vw", maxHeight: "80vh" }}
                    />
                    <div className="fourth-project-description-on-image-rt">
                  ...
                  <div className="fourth-summary-inner-div">
                    <img
                      src="public/img/projects/project6.png"
                      onClick={handleDisplayDetail}
            ...
            <div className="fourth-description-page-rt" id="id-summary">
              <div
                className="fourth-project-description-rt"
              ...
              >
                ...
                <p className="fourth-description-content-rt">
                  Chateau de Galilee is a winery dedicated to creating
                  quality&nbsp;wines sourced from selected vineyards in the
                  upper Galilee area.&nbsp;The Chateau offers a variety of
                  carefully prepared wines&nbsp;made from Israel’s finest,
                  handpicked grapes.
                </p>
                <p className="fourth-description-content-rt">
                  Chateau de Galilee is a winery dedicated to creating
              ...
              <div
                id="id-projects-detail-container"
                className="fourth-project-detail-photo-rt"
              >
                <Carousel ref={carouselRef}>
                  ...
                  <div>
                    <img
                      src="public/img/projects/project11.png"
                      style={{ width: "50vw", maxHeight: "80vh" }}
                    />
                  </div>
                  <div>
                    <img
                      src="public/img/projects/project12.png"
                      style={{ width: "50vw", maxHeight: "80vh" }}
                    />
                  </div>
                  <div>
                    <img
                      src="public/img/projects/project13.png"
                      style={{ width: "50vw", maxHeight: "80vh" }}
                    />
                  </div>
                  <div>
                    <img
                      src="public/img/projects/project14.png"
                      style={{ width: "50vw", maxHeight: "80vh" }}
                    />
                  </div>
                </Carousel>
                ...
                <div className="fourth-left-arrow-summary-rt">
                  <img
                    src="public/img/homepage/left-arrow.png"
                    onClick={handleLeftDetailClick}
                  />
                </div>
                <div className="fourth-right-arrow-summary-rt">
                  <img
                    src="public/img/homepage/right-arrow.png"
                    onClick={handleRightDetailClick}
                  />
                </div>
              </div>
            </div>
        ...
        <div style={{ position: "relative", width: "100%", height: "100%" }}>
          <div className="component fourth-component" id="id-mobile-project">
            ...
            <div className="mobile-project-detail-description">
              ...
              <p>
                Chateau de Galilee is a winery dedicated to creating
                quality&nbsp;wines sourced from selected vineyards in the upper
                Galilee area.&nbsp;The Chateau offers a variety of carefully
                prepared wines&nbsp;made from Israel’s finest, handpicked
                grapes.
              </p>
              <p>
                Chateau de Galilee is a winery dedicated to creating
            ...
            <div>
              ...
              <div className="mobile-project-description-wrapper">
                <div className="mobile-project-description"></div>
              </div>
            </div>
            <div>
              <div className="mobile-project-small-image">
